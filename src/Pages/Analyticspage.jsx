import { BarChart2, TrendingUp, Users, Zap, ArrowLeft, ArrowRight, Play } from "lucide-react";
import { useNavigate } from "react-router-dom";
import analytics from "../assets/fetures/anyaltics.png";
...
const benefits = [
  { icon: TrendingUp, title: "Sales Dashboard",   desc: "See today's revenue, best-sellers, and peak hours at a glance." },
  { icon: BarChart2,  title: "Profit & Loss",     desc: "Automatic P&L reports. Know exactly where your money goes." },
  { icon: Users,      title: "Customer Insights", desc: "Who buys what, when, and how often. Target your best customers." },
  { icon: Zap,        title: "Scheduled Reports", desc: "Get daily/weekly reports on WhatsApp or email automatically." },
];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-white text-xs font-bold uppercase tracking-wider">Analytics & Reports</span>
              </div>

              <h1 className="text-4xl lg:text-5xl font-black text-white leading-tight mb-4">
                Insights backed by real numbers.
              </h1>

              <p className="text-white/80 text-lg leading-relaxed mb-8">
                From daily sales to yearly P&L — get every insight your business needs,
                visualized beautifully and delivered automatically.
              </p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl font-black text-gray-900">Everything you need with Analytics & Reports</h2>
        </div>
      ...
      <div className={`bg-gradient-to-r ${gradient} mx-6 mb-16 rounded-3xl p-10 text-center`}>
        <h3 className="text-2xl font-black text-white mb-3">Ready to try Analytics & Reports?</h3>
